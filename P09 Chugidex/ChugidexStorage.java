...
public interface ChugidexStorage {
   ...
   * 
   * @return true if there are no Chugimon in storage, returns false if storage has
at least one
   *         Chugimon.
   */
   ...
   * @return true if the Chugimon was successfully added to stroage, false if the 
Chugimon was not
   *         added
   */
   ...
   * @return true if the Chugimon was found and removed, false if the Chugimon was 
not found
   */
   ...
   * @throws NoSuchElementException if there is no Chugimon directly after the 
provided Chugimon
   * 
   */
  public Chugimon next(Chugimon chugi);
  /**
   * Returns the previous (predecessor) of a current chugimon in this 
ChugidexStorage
   * 
...
provided Chugimon
  ...
  /**
   * Creates a string representation of this ChugidexStorage containing all the 
Chugimon. The string
