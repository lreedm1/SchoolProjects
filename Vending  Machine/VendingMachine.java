...
/**
 * VendingMachine.java is a class that represents a vending machine. It contains
 * a list of
...
public class VendingMachine {
   ...
   * 
   * @param description
   *          description of the item to be added to the vending machine
   * @param expirationDate
   *          a string parsable to a positive integer which represents the
   *          expiration
   *          date of the item. The date "0" represents January 1st 2023.
   * @param items
   *          a two-dimensional of strings storing items. items[i][0] and
   *          items[i][1]
   *          respectively represent the description and the expiration date of
   *          the
   *          item stored at index i
   * @param itemsCount
   *          number of items in the vending machine
   ...
   * 
   * @param items
   *          two dimensional array storing items within a vending machine where
   *          items[i][0] represents the description of the item at index i and
   *          items[i][1]
   *          stores its expiration date.
   * @param itemsCount
   *          (size) number of items stored in the vending machine
   * @param index
   *          index of an item within the provided vending machine
   ...
   * 
   * @param description
   *          description of the item to get its index
   * @param items
   *          two dimensional array storing items within a vending machine where
   *          items[i][0] represents the description of the item at index i and
   ...
   * 
   * @param description
   *          description of the item to remove or dispense
   * @param items
   *          array storing items within a vending machine
   * @param itemsCount
   *          (size) number of items stored in the vending machine
   ...
   * 
   * @param description
   *          description (name) of an item to search
   * @param items
   *          two dimensional array storing items within a vending machine where
   *          items[i][0] represents the description of the item at index i and
   *          items[i][1] stores its expiration date.
   ...
   * 
   * @param description
   *          description of the item to find its number of occurrences
   * @param expirationDate
   *          specific (earliest) expiration date
   * @param items
   *          two dimensional array storing items within a vending machine where
   *          items[i][0] represents the description of the item at index i and
   *          items[i][1] stores its expiration date.
  ...
  public static String getItemsSummary(String[][] items, int itemsCount) {
    ...
    for (int i = 0; i < itemsCount; i++) {
      ...
      for (int j = i; j < itemsCount; j++) {
        if (items[i][0].equals(items[j][0]) && i != j) {
          isRepeat = true;
        }
      }
      if (!isRepeat) {
