...
public class VendingMachineTester {
  ...
  public static boolean testGetItemAtIndex() {
    ...
    // check that the array contains {"Water", "15"} at index 0 and that the method
    // did not make
    ...
    if (VendingMachine.getItemAtIndex(3, items, itemsCount) != "ERROR INVALID INDEX") {
      System.out.println(
          "testGetItemAtIndex-scenario 1. Problem detected: Your getItemAtIndex did not return "
              + "the expected output when the provided index is out of bounds.");
      return false;
    }
  ...
  // Checks the correctness of getItemOccurrences defined in the VendingMachine
  // class.
  public static boolean testGetItemOccurrences() {
    ...
    // For each test scenario, ensure that the method returned the expected output
    // without making
    ...
    if (VendingMachine.getItemOccurrences("Coke", items, itemsCount) != 0) {
      System.out.println(
  ...
  public static boolean testAddItem() {
    ...
    // check that the method returns 1 when adding a new item to an empty vending
    // machine
    ...
    // check that the method returns 2 when adding a new item to a non-empty
    ...
    // check that the method returns 2 when adding a new item to a full vending
    // machine
  ...
  public static boolean testRemoveNextItem() {
    ...
    // check that the method returns 7 when trying to remove a non-existing item
    // from a non-empty
    // vending machine
  ...
  // Checks the correctness of getItemsSummary defined in the VendingMachine
  // class.
  public static boolean testGetItemsSummary() {
    ...
    // check that the method returns the correct summary for an empty vending
    // machine
    if (!VendingMachine.getItemsSummary(new String[0][0], 0).equals("")) {
      System.out.println(
          "testGetItemsSummary-scenario 1. Problem detected: Your getItemsSummary did not return "
              + "the correct summary for an empty vending machine.");
      return false;
    }
    // check that the method returns the correct summary for a vending machine with
    // non duplicate
    // items
    if (!VendingMachine.getItemsSummary(new String[][] { { "Water", "15" }, { "Chocolate", "10" } },
        2).equals("Water (1)\nChocolate (1)")) {

      System.out.println(
          "testGetItemsSummary-scenario 2. Problem detected: Your getItemsSummary did not return "
              + "the correct summary for a vending machine with non duplicate items.");
    }

    // check that the method returns the correct summary for a vending machine with
    // multiple
    // items with the same description at various index locations
    String summary = VendingMachine.getItemsSummary(new String[][] { { "Water", "15" },
        { "Chocolate", "10" }, { "Water", "5" }, { "Candy", "30" }, { "Water", "15" }, { "Chocolate", "10" } },
        6);
    if (!summary.equals("Candy (1)\nWater (3)\nChocolate (2)")) {
      System.out.println(
          "testGetItemsSummary-scenario 3. Problem detected: Your getItemsSummary did not "
              + "return the correct summary for a vending machine with multiple items with the "
              + "same description at various index locations. Instead, it returned: " + summary);
      return false;
    }
  ...
  public static boolean runAllTests() {
    return testGetIndexNextItem() && testContainsItem() && testGetItemAtIndex()
        && testGetItemOccurrences() && testAddItem() && testRemoveNextItem()
        && testGetItemsSummary();
  }
