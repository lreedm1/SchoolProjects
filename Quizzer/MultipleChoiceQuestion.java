 ...
 * object has a
 * title, points, a question (the stem), a list of possible answers, and only
 * one
 * correct answer.
 *
...
public class MultipleChoiceQuestion {
  ...
  /**
   * Index of the answer selected by the student taking this question. This index
   * equals -1 if the
  ...
  /**
   * Creates a new MultipleChoiceQuestion (MCQ) with the provided information. We
   * assume that title,
   ...
   * @param answers            A FULL perfect size array storing the list of
   *                           possible answers or
   *                           responses. We assume that the array does NOT
   *                           contain
   *                           any NULL
   *                           references.
   * @param correctAnswerIndex index of the correct answer
   * @param pointsPossible     score assigned to this question
   * @throws IndexOutOfBoundsException with a descriptive error message if
   *                                   correctAnswerIndex is out
   *                                   of the range 1 .. answers.length inclusive
   * @throws IllegalArgumentException  with a descriptive error message if
   *                                   pointsPossible is less or
   *                                   equal to zero
   */
  ...
  /**
   * Sets the title for this question. We assume that the input title is valid
   * (not
   * null nor blank)
   * 
  ...
  /**
   * Returns a String representation of the different answer options of this
   * MultipleChoiceQuestion.
   * Every answer option should be represented in a separate line preceded by
   * index+1 followed by a
   * dot and one space, where index represents the index of the answer option
   * within the answers
   ...
   * 
   * @return a String representation of the different answer options of this
   *         MultipleChoiceQuestion.
   */
  ...
  /**
   * Sets or updates the index of the correct answer within the array of possible
   * answers
   * 
  ...
  /**
   * Checks whether the student answer index matches the index of the correct
   * answer
   * 
...
pointsPossible is negative
  ...
  // String Version:
  /**
   * Returns a String representation of this MultipleChoiceQuestion conforming to
   * the following
   * format.
   * 
   ...
   * "\n" +
   * 
   * "Available Answers:\n" + getAnswers() // the string representation of the
   * possible answers.
   * + "\nSelected Answer:" +
   */
  @Override
   ...
   * @return true if other is instance of MultipleChoiceQuestion and has the same
   *         tile, question,
   *         pointsPossible, correctAnswerIndex, and list of possible answers as
   *         this
