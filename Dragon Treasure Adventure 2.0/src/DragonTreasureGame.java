...
public class DragonTreasureGame extends PApplet {
  ...
  */
  public void draw() {
    ...
    * they can obtain the key if they are in the same room as the keyholder
    * If they obtain the key, print "KEY OBTAINED" to the console
    */
    ...
    */
    ...
    // Check if it's the dragon's turn to move, move the dragon if isDragonTurn is true
    if (isDragonTurn) {
      ...
      System.out.println(dragon.getCurrentRoom());
      System.out.println("2");
    /** Update the gameState datafield to reflect the current game state
    * If the player is in the treasure room, the game is won and gameState = 1
    * If the player is in the same room as the dragon, the game is lost and gameState = 2
    */
