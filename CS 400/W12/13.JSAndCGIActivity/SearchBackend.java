...
public class SearchBackend {
	...
	public static void main(String[] args) {
		...
		for (HashMap<String,String> item : results) {
			...
			isFirst = false;
			//  Add a loop that adds all the attributes on the
	...
	/**
	 * This method uses HashMapCsvReader to search through a CSV file and returns results
	 * as a list of HashMap<String,String> that maps attributes for each data item to the
